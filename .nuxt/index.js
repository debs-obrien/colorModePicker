...
import nuxt_plugin_pluginserver_502c8729 from 'nuxt_plugin_pluginserver_502c8729' // Source: ./color-mode/plugin.server.js (mode: 'server')
import nuxt_plugin_pluginclient_2b19d4be from 'nuxt_plugin_pluginclient_2b19d4be' // Source: ./color-mode/plugin.client.js (mode: 'client')
...
async function createApp (ssrContext) {
  ...
  if (process.server && typeof nuxt_plugin_pluginserver_502c8729 === 'function') {
    await nuxt_plugin_pluginserver_502c8729(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_2b19d4be === 'function') {
    await nuxt_plugin_pluginclient_2b19d4be(app.context, inject)
  }
